...
class Accounts_form extends common {
	...
	function get_customer_form_fields($entity_type = false, $id = false, $reseller_id = '') {
		...
		$ie_city_val        = 'accounts.tax_city_number';
		...
		if ($id > 0) {
			...
			$ie_city_val = 'accounts.tax_city_number.'.$id;
			$taxes_array = array(
				gettext('Taxes'),
				"tax_id",
				'SELECT',
			...
			$tax_city_number = array(
				gettext('IE Number'),
				'INPUT',
				array(
					'name'     => 'tax_city_number',
					'value'    => $ie_city_val,
					'size'     => '30',
					'class'    => "text field medium",
					'id'       => 'tax_city_number',
				),
				'trim|xss_clean|is_unique['.$ie_city_val.']|max_length[18]',
				'tOOL TIP',
				'',
				'',
			);
